...
Official IPDC Facilities: 10 SEZs + 1 FTZ + 2 Industrial Parks = 13 Total
...
ETHIOPIAN_PARKS = [
    ...
    },
    {
        ...
        'status': 'under_development',
        'established_year': 2020,
        'focus_industries': ['horticulture', 'agro_processing', 'food_processing'],
        ...
        'utility_cost_score': 7,
        'incentives': ['tax_holiday', 'export_support', 'agro_incentives'],
        'description': 'Industrial park focused on horticulture and agro-processing for export markets'
    }
]
...
if __name__ == '__main__':
    ...
    print("\n" + "=" * 70)
    print("\nAll parks:")
    for i, park in enumerate(ETHIOPIAN_PARKS, 1):
        print(f"   {i}. {park['park_name']} ({park['park_type']}) - {park['status']}")
    print("=" * 70)
