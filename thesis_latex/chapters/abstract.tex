...
The research makes four contributions: (1) a Technology Adaptation Framework that guides the transfer of digital governance models across different connectivity contexts; (2) an Offline-First Industrial Service Architecture that extends PWA capabilities to support complex workflows; (3) a set of Design Principles for deciding which features to prioritize for offline use; and (4) the first purpose-built digital platform tailored to Ethiopian industrial parks. Together, these findings offer a replicable approach to digital transformation in connectivity-constrained settings throughout Africa and other developing regions.
