...
The design combines qualitative and technical methods inside the DSR framework. Stakeholder surveys, document analysis, and Chinese platform review built the picture of what the problem actually was and what a solution needed to do. Iterative development and systematic testing produced and validated the artifact itself. DSR doesn't lock you into a specific method --- it uses whatever is needed to build and rigorously evaluate the artifact \citep{Hevner2004}.
