...
The methodology rests on Design Science Research as the overarching paradigm, a structured multi-source data collection process, and agile-inspired iterative development. Forty-nine respondents from eleven parks across Ethiopia supplied both quantitative measurements and narrative accounts of how service delivery actually operates --- the kind of detail that Likert scales miss. Document analysis and a systematic examination of WeChat Work and DingTalk provided the design source material. Technology choices followed offline-first requirements before any other consideration, a decision that shaped every subsequent architectural move. Technical offline testing and the SUS instrument handled evaluation. The DSRM process held everything together, keeping the research accountable to scientific rigour and operational reality in equal measure.
