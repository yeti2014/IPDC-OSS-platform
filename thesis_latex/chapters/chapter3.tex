...
Field visits to IPDC industrial parks provided firsthand insight into service delivery workflows, infrastructure conditions, and user behavior. Observations focused on:
...
These observations complemented the questionnaire findings by surfacing tacit aspects of service delivery that stakeholders might not articulate in a structured survey.
...
This chapter laid out the research methodology, with Design Science Research as the overarching paradigm and the DSRM process model organizing the work into six activities from problem identification through to communication. Data collection drew on stakeholder questionnaires (49 respondents across eleven parks), document analysis, Chinese platform analysis, and field observations, while development followed agile-inspired iterations with technology choices driven by offline-first requirements. The evaluation framework combines technical assessment of offline functionality, synchronization, and performance with SUS usability evaluation and DSR guidelines compliance review. The next chapter presents the system analysis and design, covering stakeholder requirements, the China-to-Ethiopia adaptation framework, and the resulting system architecture.
