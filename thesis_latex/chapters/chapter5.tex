...
\small
\begin{tabular}{p{2.8cm}p{1.5cm}p{1.5cm}p{3.5cm}p{3cm}}
\toprule
\textbf{Model} & \textbf{Records} & \textbf{Features} & \textbf{Algorithm} & \textbf{Target} \\
\midrule
...
\small
\begin{tabular}{p{2.8cm}p{2.5cm}p{3cm}p{2.5cm}}
\toprule
...
Pred.\ Maintenance & $R^{2}$ (days to failure) & Huawei FP: 80--88\% & 0.9989 \\
 & Risk accuracy & --- & 99\% \\
...
The technical tests confirm the offline-first architecture works as designed. The SUS results show that real IPDC stakeholders across all three roles found the system usable. Chapter~\ref{ch:conclusion} draws out what those two findings mean together.
